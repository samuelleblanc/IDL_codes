...
indir ='/lustre/janus_scratch/leblanse/cloud/input/sp_hires7_'+date+'/';'/scratch/stmp00/leblanse/cloud/input/'
outdir='/lustre/janus_scratch/leblanse/cloud/output/sp_hires7_'+date+'/';'/scratch/stmp00/leblanse/cloud/output/'
...
spawn,'mkdir '+outdir
;spawn,'mkdir '+dir
list_file='/projects/leblanse/cloud/run_cloud_sp_hires7_'+date+'.sh'
...
ref=[10.,11.,12.,13.,14.,15.,16.,17.,18.,20.,22.,23.,24.,25.,26.,28.,29.,30.,32.,33.,35.,38.,40.,42.,45.,48.,50.]
...
;for v5
atm_file='/lustre/janus_scratch/leblanse/wx/atmos_aero_20130110_at.dat'
alb_file='/lustre/janus_scratch/leblanse/albedo_2013-01-10.dat';snow_albedo.dat'; albedo_2012-05-24.dat'
...
zout=[0.02]
  for t=0, n_elements(tau)-1 do begin
    for r=0, n_elements(ref)-1 do begin
          ...
          outf=outdir+fn+'.out'
          inf =indir +fn+'.in'
          inf2=indir +'../sp_hires6_20130110_snd/'+fn+'.in'
          cloud=[tau[t],ref[r],7.0+1.68,1.5]
          wvl=[400.,1700.]
          albedo=0.2
...
;             /radiance,/quiet,cloud=cloud,alb_file=alb_file
         write_inp_mix, doy, sza, atm_file, inf, azi, wvl, zout, $
           /quiet, cloudl=cloud,alb_file=alb_file,cloudi=cloud, wp=0.,wc_mie=wc_mie,/nofile,noff=inf2
...
;           /radiance,/quiet,cloud=cloud,alb_file=alb_file,/ice,/ic_files
          write_inp_mix, doy, sza, atm_file, inf, azi, wvl, zout, $
           /quiet, cloudl=cloud,alb_file=alb_file,cloudi=cloud, wp=1.,ic_dat=ic_dat,/nofile,noff=inf2
          printf, uu, '/projects/leblanse/libradtran/libRadtran-1.7/bin/uvspec < '+inf+' > '+outf
          print, inf
    endfor   ;ref loop
  endfor    ;tau loop
