...
date='20120525_all'
lbl='20120912_snd'
outdir='/lustre/janus_scratch/leblanse/cloud/output/sp_hires3_'+lbl+'/';'/scratch/stmp00/leblanse/cloud_rad/output/'
...
save, zenlambda, tau, ref, sp, sp_irrdn,sp_irrup,filename=dir+'sp_hires_'+lbl+'.out'
