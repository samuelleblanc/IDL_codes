...
date='20120824'
outdir='/lustre/janus_scratch/leblanse/cloud/output/ice_liq/';'/scratch/stmp00/leblanse/cloud_rad/output/'
...
fns=['cloud_ice_liq_10','cloud_ice_liq_20','cloud_ice_liq_30','cloud_ice_liq_40',$
     'cloud_ice_liq_50','cloud_ice_liq_60','cloud_ice_liq_70','cloud_ice_liq_80','cloud_ice_liq_90']
fns=['/lustre/janus_scratch/leblanse/cloud/output/tablesp/cloud_tb_ta01_re04',outdir+fns,$
     '/lustre/janus_scratch/leblanse/cloud/output/tablesp/cloud_tb_ta01_re04_ice']
...
save, zenlambda, tau, ref, ice, sp, filename=dir+'sp_ice_liq_part.out'
