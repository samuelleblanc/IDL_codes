...
date='20120824'
outdir='/lustre/janus_scratch/leblanse/cloud/output/szas2/';'/scratch/stmp00/leblanse/cloud_rad/output/'
...
sp=fltarr(n_elements(sza),n_elements(zenlambda[u]),2)
...
save, zenlambda, tau, ref, sza,sp, filename=dir+'sza_liq_ice.out'
