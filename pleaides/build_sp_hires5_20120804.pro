...
;indir ='/lustre/janus_scratch/leblanse/cloud/rt_files/input/sp_hires5_'+date+'/'
;outdir='/lustre/janus_scratch/leblanse/cloud/rt_files/output/sp_hires5_'+date+'/'
...
;           /radiance,/quiet,cloud=cloud,alb_file=alb_file,/ice,/ic_files
          write_inp_mix, doy, sza, atm_file, inf, azi, wvl, zout, $
           /quiet, cloudl=cloud,alb_file=alb_file,cloudi=cloud, wp=1.,/nofile
          printf, uu, '/projects/leblanse/libradtran/libRadtran-1.7/bin/uvspec < '+inf+' > '+outf
          print, inf
    endfor   ;ref loop
  endfor    ;tau loop
