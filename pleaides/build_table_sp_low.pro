...
@zensun.pro
@make_ic_files.pro
pro build_table_sp_low

;set the proper directories
date='20120824'

indir ='/lustre/janus_scratch/leblanse/cloud/input/tablesp_new3_low/';'/scratch/stmp00/leblanse/cloud/input/'
outdir='/lustre/janus_scratch/leblanse/cloud/output/tablesp_new3_low/';'/scratch/stmp00/leblanse/cloud/output/'
dir   ='/projects/leblanse/cloud/'

spawn,'mkdir '+indir
spawn,'mkdir '+outdir
;spawn,'mkdir '+dir
list_file='/projects/leblanse/cloud/run_cloud_tablesp_new3_low.sh'
