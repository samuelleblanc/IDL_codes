...
indir ='/lustre/janus_scratch/leblanse/cloud/input/slope_ic_'+date+'/';'/scratch/stmp00/leblanse/cloud/input/'
...
spawn,'mkdir '+outdir
;spawn,'mkdir '+dir
list_file='/projects/leblanse/cloud/run_cloud_slope_ic_'+date+'.sh'
...
atm_file='/lustre/janus_scratch/leblanse/wx/afglmw.dat' ;'/projects/leblanse/libradtran/libRadtran-1.6-beta/data/atmmod/afglms.dat'
alb_file='/lustre/janus_scratch/leblanse/snow_albedo.dat';snow_albedo.dat'; albedo_2012-05-24.dat'
;alb_file='/lustre/janus_scratch/leblanse/albedo_2012-05-24.dat'
  for t=0, ntau-1 do begin
    for r=0, nref-1 do begin
      for s=0, nsza-1 do begin
        for v=0, nwvl-1 do begin     
          ...
          outf=outdir+fn+'.out'
          inf =indir +fn+'.in'
          cloud=[taus[t],refs[r],1.5+1.68,1.5]
;          wvl=[wvls[v],wvls[v]]
          if v eq 0 then wvl=[wvls[0],wvls[0]] else wvl=[wvls[1],wvls[n_elements(wvls)-1]]
;          albedo=0.2
...
;             /radiance,/quiet,cloud=cloud,alb_file=alb_file
         write_inp_mix, doy, szas[s], atm_file, inf, azi, wvl, zout, $
           /quiet, cloudl=cloud,alb_file=alb_file,cloudi=cloud, wp=1.,/slit,/kurudz,ic_dat=ic_dat
