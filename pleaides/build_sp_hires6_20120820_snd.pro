...
;for v5
atm_file='/lustre/janus_scratch/leblanse/wx/atmos_aero_20120820_at.dat.dat'
...
;             /radiance,/quiet,cloud=cloud,alb_file=alb_file
         write_inp_mix, doy, sza, atm_file, inf, azi, wvl, zout, $
           /quiet, cloudl=cloud,alb_file=alb_file,cloudi=cloud, wp=0.,wc_mie=wc_mie,/nofile,noff=inf
...
;           /radiance,/quiet,cloud=cloud,alb_file=alb_file,/ice,/ic_files
          write_inp_mix, doy, sza, atm_file, inf, azi, wvl, zout, $
           /quiet, cloudl=cloud,alb_file=alb_file,cloudi=cloud, wp=1.,ic_dat=ic_dat,/nofile,noff=inf
          printf, uu, '/projects/leblanse/libradtran/libRadtran-1.7/bin/uvspec < '+inf+' > '+outf
          print, inf
    endfor   ;ref loop
  endfor    ;tau loop
