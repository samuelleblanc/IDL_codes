...
date='20120824'
outdir='/lustre/janus_scratch/leblanse/cloud/output/tablesp_new3_nstr/';'/scratch/stmp00/leblanse/cloud_rad/output/'
...
save, zenlambda, tau, ref, sp, filename=dir+'sp_liq_ice_new3_nstr.out'
