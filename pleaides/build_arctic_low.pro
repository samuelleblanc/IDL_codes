...
date='20130911_ice_lowt'
date='20130911_sea_lowt'
date='20130911_snow_ice_lowt'
vv='v1'
;pw=5./9.2*(18.3+9.2)
...
lat=70.0;29.609106 ;40.0079166
lon=-120.0;-95.168302 ;-105.26825
...
atm_file='/lustre/janus_scratch/leblanse/wx/atmos_aero_20130911_at.dat'
;alb_file='/lustre/janus_scratch/leblanse/wx/albedo_snow_ice.dat';snow_albedo.dat'; albedo_2012-05-24.dat'
;alb_file='/lustre/janus_scratch/leblanse/wx/snow_albedo.dat'
alb_file='/lustre/janus_scratch/leblanse/wx/albedo_ice.dat'

zout=[0.2,3.0] & albedo=0.2
  for t=0, n_elements(tau)-1 do begin
    for r=0, n_elements(ref)-1 do begin
       cloud=[tau[t],ref[r],1.0,0.5]
        if ref[r] le 30. then begin       
          ...
          write_inp_mix, doy, sza, atm_file, inf, azi, wvl, zout,$; /nofile,noff=inf2,$ 
           /quiet, cloudl=cloud,alb_file=alb_file,cloudi=cloud, wp=0.,wc_mie=wc_mie,/kurudz,/sli;,/sea;,/prof; ,pw=pw
          ...
          wvl=[981.,1700.]
          write_inp_mix, doy, sza, atm_file, inf, azi, wvl, zout,$; /nofile,noff=inf2,$ 
           /quiet, cloudl=cloud,alb_file=alb_file,cloudi=cloud, wp=0.,wc_mie=wc_mie,/kurudz,/slit, /sea;,/prof ;,pw=pw
          printf, uu, '/projects/leblanse/libradtran/libRadtran-1.7/bin/uvspec < '+inf+' > '+outf
        endif
        print, tau[t],ref[r] 
        ...
        if ref[r] ge 5. then begin
          ...
          wvl=[400.,981.]
          write_inp_mix, doy, sza, atm_file, inf, azi, wvl, zout,$;/nofile,noff=inf2,$
           /quiet, cloudl=cloud,alb_file=alb_file,cloudi=cloud, wp=1.,ic_dat=ic_dat,/kurudz,/slit, /sea;,/prof ;,pw=pw
          printf, uu, '/projects/leblanse/libradtran/libRadtran-1.7/bin/uvspec < '+inf+' > '+outf
