...
pro build_sp_hires4,date

;set the proper directories
if n_elements(date) lt 1 then date='20120524'

indir ='/lustre/janus_scratch/leblanse/cloud/input/sp_hires4_'+date+'/';'/scratch/stmp00/leblanse/cloud/input/'
outdir='/lustre/janus_scratch/leblanse/cloud/output/sp_hires4_'+date+'/';'/scratch/stmp00/leblanse/cloud/output/'
dir   ='/projects/leblanse/cloud/'

spawn,'mkdir '+indir
spawn,'mkdir '+outdir
;spawn,'mkdir '+dir
list_file='/projects/leblanse/cloud/run_cloud_sp_hires41_'+date+'.sh'

alb=0.2

;make the table spacing
tau=[1.,2.,3.,4.,5.,7.5,10.,15.,20.,25.,30.,40.,50.,60.,70.,80.,90.,100.]
ref=[2.5,5.,7.5,10.,12.5,15.,17.5,20.,22.5,25.,30.,35.,40.,45.,50.]


lat=40.007916667
lon=-105.26825
if strmid(date,0,1) ne '2' then date='20130110'
...
atm_file='/lustre/janus_scratch/leblanse/wx/atmos_aero_20120525_at.dat' ;'/projects/leblanse/libradtran/libRadtran-1.6-beta/data/atmmod/afglms.dat'
atm_file='/lustre/janus_scratch/leblanse/wx/afglms.dat'
...
;             /radiance,/quiet,cloud=cloud,alb_file=alb_file
         write_inp_mix, doy, sza, atm_file, inf, azi, wvl, zout, $
           /quiet, cloudl=cloud,alb_file=alb_file,cloudi=cloud, wp=0.,/wc_included
...
;          write_inp_mix, doy, sza, atm_file, inf, azi, wvl, zout, $
;           /quiet, cloudl=cloud,alb_file=alb_file,cloudi=cloud, wp=1.
;          printf, uu, '/projects/leblanse/libradtran/libRadtran-1.7/bin/uvspec < '+inf+' > '+outf
          print, inf
    endfor   ;ref loop
  endfor    ;tau loop
