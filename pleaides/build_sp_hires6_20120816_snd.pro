...
;for v5
atm_file='/lustre/janus_scratch/leblanse/wx/atmos_aero_20120816_at.dat.dat'
alb_file='/lustre/janus_scratch/leblanse/albedo_2012-08-20.dat';snow_albedo.dat'; albedo_2012-05-24.dat'
...
zout=[0.02]
  for t=0, n_elements(tau)-1 do begin
    for r=0, n_elements(ref)-1 do begin
          ...
          outf=outdir+fn+'.out'
          inf =indir +fn+'.in'
          inf2=indir +'../sp_hires6_20120816_snd/'+fn+'.in'
          cloud=[tau[t],ref[r],1.0+1.68,1.5]
          wvl=[400.,1700.]
          albedo=0.2
