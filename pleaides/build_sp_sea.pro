...
indir ='/lustre/janus_scratch/leblanse/cloud/input/sp_'+date+'/';'/scratch/stmp00/leblanse/cloud/input/'
outdir='/lustre/janus_scratch/leblanse/cloud/output/sp_'+date+'/';'/scratch/stmp00/leblanse/cloud/output/'
dir   ='/projects/leblanse/cloud/'

spawn,'mkdir '+indir
spawn,'mkdir '+outdir
;spawn,'mkdir '+dir
list_file='/projects/leblanse/cloud/run_cloud_sp_'+date+'.sh'
...
atm_file='/lustre/janus_scratch/leblanse/afglmw.dat' ;'/projects/leblanse/libradtran/libRadtran-1.6-beta/data/atmmod/afglms.dat'
alb_file='/lustre/janus_scratch/leblanse/sea_alb.dat' ;albedo_2012-05-24.dat'
zout=[0.35]
...
printf,ui,'solar_file        /projects/leblanse/libradtran/libRadtran-1.6-beta/data/solar_flux/kurudz_1.0nm.dat';/projects/leblanse/libradtran/solar_SSFR.dat'
