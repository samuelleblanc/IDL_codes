...
dir='/home/leblanc/arctas/nasa/20080709/janus/';'/home/leblanc/libradtran/output/aero/'
aats_dir='/data/seven/schmidt/polar/nasa/'
; get rtm results
  ; get tau modified
  f=file_search(dir+'rtm_taumod_hsrl_abs_'+date+'_wvl*.txt')
  f=f[sort(f)]
  print, f
...
save, rad_up,no_rad_up,rad_dn, no_rad_dn, aot, wvl_arr,forcing, eff,effp,ssa, asy,asy2,albedo, filename='/home/leblanc/arctas/nasa/'+date+'/'+date+'_forcing_abs.out'
