...
if linux then begin
standard_atmosphere='/home/leblanc/libradtran/libRadtran-1.5-beta/data/atmmod/afglsw.dat';input/aero/atmos_aero_20100519.dat'
...
standard_atmosphere='\\lasp-smb\leblanc\libradtran\libRadtran-1.5-beta\data\atmmod\afglsw.dat' ;input\aero\atmos_aero_'+date+'.dat'
file='\\lasp-smb\leblanc\libradtran\input\aero\atmos_aero_'+date
