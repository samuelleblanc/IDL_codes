...
if plot then begin
  ...
  device, xsize=16, ysize=16
		...
		contour,nspectra,nadlambda, utc, tit='SSFR UP',xtit='wavelength [nm]',ytit='',xr=[350,2200],/cell_fill,/xs,/ys, max_value=3.,min_value=0.,nlevels=15,color=255, thick=4, position=[0.5,0.1,0.92,0.95]
		
		COLORBAR, POSITION=[0.94, 0.10, 0.97, 0.95],/right,/vertical, range=[0.,3.],title='Irradiance [W m!E-2!N nm!E-1!N]',color=255
		;p=tvrd(true=1)
