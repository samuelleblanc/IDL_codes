...
; special processing
if strcmp(date,'20100309') then begin
  !P.multi=0
  alt=0.
  ...
  get_cos,dir,date,cfg_file,utc,alt,sza,cos(sza*!pi/180.),zenlambda,fac,dz,nadlambda,facn,dn
  ...
  utc0=20.6 ; plot spectra here
  mm=min(abs(utc-utc0),utcind)

  window,0,tit='Side-by-Side-Time-Series'
  yr=[0,1.5]
  plot ,utf,zspectra[zind[0],*]*fac,xr=[u0,u1],xtit='UTC [h]',ytit='Measured Irradiance [W m!E-2!N nm!E-1!N]',yr=yr,/xs,/ys,tit='NASA Ames Side by Side SSFR-6 zenith nadir '+date
  oplot,utf,nspectra[nind[0],*]*facn,linesty=1,color=40
  ...
  window,1,tit='Side-by-Side-Spectra-Direct-Corr'
  ;xr=[350,2150]
  xr=[350,2150]
  yr=[0,2]
  plot ,zenlambda,zspectra[*,utcind]*fac[utcind],xr=xr,/xs,yr=yr,/ys,xtit='Wavelength [nm]',ytit='Irradiance [W m!E-2!N nm!E-1!N]',tit='Spectra at utc='+strcompress(string(utc0),/remove_all)+' dir corr'
  oplot,nadlambda,nspectra[*,utcind]*facn[utcind]*1.03,color=120


  legend,['Zenith','Nadir'],textcolors=[255,120],/right;,linesty=[0,0,0,0],colors=[255,120,70,200]
  p=tvrd(true=1)
  ;write_png,'C:\calnex\p3\20100309\side-by-side-spectra-dir.png',p
