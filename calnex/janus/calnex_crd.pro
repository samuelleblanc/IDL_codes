...
;
; KEYWORDS:
;   - no_pas: when there is no PAS file available, abs returns nothing
;
; DEPENDENCIES:
;   
;
...
; Modified: September 14th, 2011, by Samuel LeBlanc
;           - added no_pas keyword
; 
;---------------------------------------------------------------------------
pro calnex_crd, dateinp, time, ext, ext_ambient, abs, no_pas=no_pas
...
if not keyword_set(no_pas) then begin
  ; get PAS .ict file
...
endif else abs=crd.field1[1,*]*!values.f_nan
