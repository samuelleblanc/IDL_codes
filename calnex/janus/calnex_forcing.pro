...
;stop
	...
	write_input_file, doy, sza, dir+tau_out, dir+atm_in, input_file, azimuth, asy, ssa, wvl, zout,albedo, /radiance,/quiet, tau_scale=tauscale ,/slit,/no_aero
    if linux then spawn, '/home/leblanc/libradtran/libRadtran-1.5-beta/bin/uvspec < '+input_file+' > '+output_file , message else message, 'Must be under linux'
    if message ne '' gt 0 then message, message
...
save, rad_up,no_rad_up,rad_dn, no_rad_dn, aot, wvls,forcing, eff,effp,ssa, asy,asy2,albedo, filename='/home/leblanc/CALNEX/p3/20100519/20100519_forcing.out'
stop
