...
dir='C:\calnex\cal\ssfr6_wl_cal\hg_6035_lamp\'
;dir='C:\calnex\cal\ssfr6_wl_cal\NIR\'
;dir='C:\calnex\cal\ssfr6_wl_cal\HeNe\'
ll ='\'
np=256
nasa=0 ; this indicates we are using SSFR-5 (the NASA P-3 system)
noaa=1 ; this indicates we are using SSFR-6 (the NOAA P-3 system)
...
;if nasa then cn=[[304.374,3.30444,9.06172E-05,-1.31076E-06,0],[2226.93,-4.48862,-0.00050990,-7.40257e-06,-4.28565e-09]] ; Actually, nasa nadir si is slightly different in the wl cal file! That could affect the short wavelengths!
