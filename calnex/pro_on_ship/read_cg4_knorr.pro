...
while not eof(uu) do begin
  ...
  bitand=(block.temperature1[0] AND block.temperature1[1] AND block.temperature1[2] AND $
    block.reartemp1[0] AND block.reartemp1[1] AND block.reartemp1[2] AND $
    block.systemp1[0] AND block.systemp1[1] AND block.systemp1[2] AND $
    block.caltemp1[0] AND block.caltemp1[1] AND block.caltemp1[2])

  if(bitand eq 'AA'X or bitand eq '55'X) then continue
