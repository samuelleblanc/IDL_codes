...
cfg_dir='/home/radusers/ATTREX/GHflt/sciflt/'
osa_dir='/home/radusers/ATTREX/GHflt/sciflt/'
cg4_dir='/home/radusers/ATTREX/GHflt/cg4/'
out_dir='/home/radusers/ATTREX/GHflt/nav/'
...
for i=0, n_cg4-1 do begin
  ...
  if i ne n_cg4-1 and infocg4.size ne 7600 then begin
...
fl  = where(finite(ssfr_utc) eq 1)
flc = where(finite(cg4_utc) eq 1)

utc = ssfr_utc[fl]

zspectra      = [[spect_cal_all[fl,indices[0,0]:indices[1,0],0]],[spect_cal_all[fl,indices[0,1]:indices[1,1],1]]]
nspectra      = [[spect_cal_all[fl,indices[0,2]:indices[1,2],2]],[spect_cal_all[fl,indices[0,3]:indices[1,3],3]]]
ssfr_temp_all = ssfr_temp_all[fl,*]

zcg4_temp = cg4_temp_all[flc,0]
ncg4_temp = cg4_temp_all[flc,1]
zcg4      = cg4_I_all[flc,0]
ncg4      = cg4_I_all[flc,1]
