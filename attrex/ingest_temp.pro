...
;
; PURPOSE:
;   to change the ssfr thermistor voltages to celsius, witht he cfg file
;
; CATEGORY:
;   ATTREX real time data module temperatures
;
; CALLING SEQUENCE:
;   ingest_temp, cfg_file, ch, temp
...
@cfg.pro
pro ingest_temp, cfg_file, ch, temp
