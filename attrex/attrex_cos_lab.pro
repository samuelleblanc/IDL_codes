...
outdir   =  '/data/seven/schmidt/attrex/ang/'


; CHOOSE SENSOR
; ATTREX : NASA GH  : LC-3 Zenith  **1**, LC-1 Nadir **2**
; Global Hawk zenith LC2
; Global Hawk nadir LC7
; Spare LC3
...
for sens = 1,3 do begin   ; the number between the ** **
