...
pro side_by_side
dir='/data/seven/schmidt/dc3/cal/SSFR5/'
date='20120411'
...
; special processing
if strcmp(date,'20110822') or strcmp(date, '20110828') or strcmp(date,'20120411') then begin
  ...
  ;rph2za,pit+pitchoff,rol+rolloff,hed,sza,azimuth
  dc = muslope(sza,azimuth,0,0) ; directional cosine
 ...
 ; tau = bodhaine(zenlambda,pressure, 0.)
  ...
  utc0=19.0 ; plot spectra here
  mm=min(abs(utc-utc0),utcind)

  window,0,tit='Side-by-Side-Time-Series',retain=2
  yr=[0,1.8]
...
!p.multi=[0,2,1]
  window,1,tit='Side-by-Side-Spectra-Direct-Rayleigh-Corr',retain=2
  ;xr=[350,2150]
  xr=[350,2150]
  yr=[0,2]
  ...
  window,2,tit='Side-by-Side-Spectra-Diffuse-Corr',retain=2
