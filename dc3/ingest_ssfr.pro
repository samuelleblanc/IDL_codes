...
while not eof(lun) do begin ; Read individual spectra
  ...
  if ssfr3 then begin 
    ...
    if drktime then begin
      mmmp=double(mm)+double(ss+15.0)/60.
      mmml=double(mm)+double(ss-15.0)/60.
  ...
  if ssfr3_sh then begin ; shutter open
    ...
    if ssfr3 then begin 
      ...
      raw[n_ctr,*,1]=[spect.zspecir[0:127],spect.zspecir[128:*]]
      raw[n_ctr,*,2]=spect.nspecsi
      raw[n_ctr,*,3]=[spect.nspecir[0:127],spect.nspecir[128:*]]
    ...
    if ssfr3 then begin
      ...
      drk_tmp[n_drk,*,1]=[spect.zspecir[0:127],spect.zspecir[128:*]]
      drk_tmp[n_drk,*,2]=spect.nspecsi
      drk_tmp[n_drk,*,3]=[spect.nspecir[0:127],spect.nspecir[128:*]]
    endif else begin
      drk_tmp[n_drk,*,0]=spect.zspecsi
...
if n_drk gt 0 then n_drk=n_drk-1
drk_tmp  = drk_tmp[0:n_drk,*,*]
