...
;@get_params3.pro
@get_params4.pro
pro build_lut_pw ;,date

vv='v1'
win=1

lbl=vv+'_20120525_'+['w0','w1','w2','w3','w4','w5']
...
print, 'got precipitable water grid of:', pws
...
if win then fn='C:\Users\Samuel\Research\SSFR3\data\par_pw_'+vv+'_'+date+'.out'
print, 'saving to:'+fn
save, pars,taus,refs,wp,pw,filename=fn
save, pars,taus,refs,wp,pw,sp_hiu,zenlambda,filename='C:\Users\Samuel\Research\SSFR3\data\sp_par_pw_'+vv+'_'+date+'.out'
endif 
