...
if win then fn='C:\Users\Samuel\Research\SSFR3\data\par_ab_'+vv+'_'+date+'.out'
print, 'saving to:'+fn
save, pars,taus,refs,wp,ab,filename=fn
save, pars,taus,refs,wp,ab,sp_hiu,zenlambda,filename='C:\Users\Samuel\Research\SSFR3\data\sp_par_ab_'+vv+'_'+date+'.out'
endif 
