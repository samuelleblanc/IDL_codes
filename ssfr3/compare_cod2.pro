...
fn=dir+date+l+date+'_norm_trans_area'
set_plot,'ps'
print, 'making plot :'+fn
 loadct, 39, /silent
 device, /encapsulated, /tt_font, set_font='Helvetica Bold',/color,bits_per_pixel=8., filename=fn+'.ps'
 ...
 !p.font=1 & !p.thick=5 & !p.charsize=2.0 & !x.style=1 & !y.style=1 & !z.style=1 & !y.thick=1.8 & !x.thick=1.8
 !p.multi=[0,1,3] & !x.margin=[7,2] &!x.omargin=[0,0]
; i=where(tmhrs gt 21. and tmhrs lt 23.0)
 i=where(tmhrs gt 15. and tmhrs lt 19.)
 plot, tau[i],v2[i,0],title='Water vapor absorption at 940 nm',xtitle='Cloud optical depth',ytitle='Integrated transmitance at 940 nm',psym=2,xrange=[0,200]
 plot, tau[i],v2[i,1],title='Water vapor absorption at 1150 nm',xtitle='Cloud optical depth',ytitle='Integrated transmitance at 1150 nm',psym=2,xrange=[0,200]
 plot, tau[i],v2[i,2],title='Oxygen-a band absorption',xtitle='Cloud optical depth',ytitle='Integrated transmitance in the Oxygen-a band',psym=2,xrange=[0,200]
device, /close
spawn, 'convert '+fn+'.ps '+fn+'.png'
endif
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; save the values ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
save, tmhrs, v2,sza,cod_ar1,cod_ar2,cod_ox,tau,ref,disd, area,area2,oxa,area2v2,filename=dir+date+l+date+'_cod_comp_2.out'
...
!p.multi=0 & !p.thick=1
window, 1, retain=2
i=where(tmhrs gt 21. and tmhrs lt 23.)
i=where(tmhrs gt 15. and tmhrs lt 19.)
...
window, 2, retain=2
plot, tau[i], v2[i,0],psym=2, xrange=[0,200],title='940nm water vapor vs tau'
window, 3, retain=2
plot, tau[i], v2[i,1],psym=2, xrange=[0,200],title='1150nm water vapor vs tau'
window, 4, retain=2
plot, tau[i], v2[i,2],psym=2, xrange=[0,200],title='oxygen-a vs tau'
endif
stop
end
