...
; vs. tau
; vs. oxygen-a
; this program uses the mpfit routines
; also outputs poster ready plots
; does this for the enhanced attenuation values
...
device, xsize=20, ysize=30
 ...
 plot,tottau, totarea3, psym=3, yrange=[0.5,4.5],title='Water vapor',xstyle=4,$
...
; oplot, tottau, totarea3, psym=3, color=247
 ...
 plot,tottau, totarea, psym=3, xstyle=4,ytitle='Path integrated attenuation enhancement',ymargin=[1,1],$
  xrange=[0,200],yrange=[0.5,4.5],/nodata
 ...
 plot,tottau, totarea2, psym=3, xstyle=9,xtitle='Cloud optical depth',xrange=[0,200],ymargin=[3,0],yrange=[0.5,4.5],/nodata
...
device, xsize=20, ysize=22
 ...
 alpha="141b  ;"
 plot,tottau, totoxa, psym=3, yrange=[0.5,2],title='Oxygen-A',$
  xrange=[0,200],ytitle='Path integrated attenuation enhancement',xtitle='Cloud optical depth',/nodata
...
plot, tottau, totarea, psym=3, title='Cloud base height',xtitle='Cloud optical depth',$
 ytitle='Path integrated attenuation enhancement', xrange=[0,200],yrange=[0.5,3.5],/nodata
...
; tvlct,240,136,000,249
u=where(tottau gt 14. and tottau lt 16.5 and totarea gt 0); and totvalid eq 1)
u1=where(tottau gt 24. and tottau lt 25.5); and totvalid eq 1)
u2=where(tottau gt 49. and tottau lt 51.); and totvalid eq 1)
u3=where(tottau gt 98. and tottau lt 102.); and totvalid eq 1)
...
plot, totwater[u], totarea[u], psym=2, title='Precipitable water',/nodata,$
 xtitle='Precipitable water (mm)',ytitle='Path integrated attenuation enhancement', xrange=[14,26],yrange=[0.5,3]

oplot, cavg,ca[*,0], psym=6, color=70
errplot,cavg,ca[*,0]-sca[*,0],ca[*,0]+sca[*,0],color=70

r=correlate(totwater[u],totarea[u]) & r=r*r
...
r1=correlate(totwater[u1],totarea[u1]) & r1=r1*r1
...
r2=correlate(totwater[u2],totarea[u2]) & r2=r2*r2
...
r3=correlate(totwater[u3],totarea[u3]) & r3=r3*r3
l3=linfit(totwater[u3],totarea[u3])
oplot, x, x*l3[1]+l3[0],color=250,linestyle=2

ta="164b ;"
legend, ['!9'+string(ta)+'!X=15, R!U2!N='+string(r,format='(F4.2)'),'!9'+string(ta)+'!X=25, R!U2!N='+string(r1,format='(F4.2)'),$
         '!9'+string(ta)+'!X=50, R!U2!N='+string(r2,format='(F4.2)'),'!9'+string(ta)+'!X=100, R!U2!N='+string(r3,format='(F4.2)')],textcolors=[70,130,201,250],box=0,charsize=2.8
device, /close
spawn, 'convert '+fn+'.ps '+fn+'.png'
endif

;;;;; do the same for the oxygen a band
fn=dir+'water_precip_oxa_enh'
set_plot,'ps'
print, 'making plot :'+fn
loadct, 39, /silent
device, /encapsulated, /tt_font, set_font='Helvetica Bold',/color,bits_per_pixel=8., filename=fn+'.ps'
...
for j=0, 24 do begin
  ns=where(totwater[u] gt cbins[j] and totwater[u] le cbins[j+1],nu)
  if nu gt 0 then begin
    ca[j,0]=mean(totoxa[u[ns]],/nan)
    sca[j,0]=stddev(totoxa[u[ns]],/nan)
  endif
  ns=where(totwater[u1] gt cbins[j] and totwater[u1] le cbins[j+1],nu)
  if nu gt 0 then begin
    ca[j,1]=mean(totoxa[u1[ns]],/nan)
    sca[j,1]=stddev(totoxa[u1[ns]],/nan)
  endif
  ns=where(totwater[u2] gt cbins[j] and totwater[u2] le cbins[j+1],nu)
  if nu gt 0 then begin
    ca[j,2]=mean(totoxa[u2[ns]],/nan)
    sca[j,2]=stddev(totoxa[u2[ns]],/nan)
  endif
  ns=where(totwater[u3] gt cbins[j] and totwater[u3] le cbins[j+1],nu)
  if nu gt 0 then begin
    ca[j,3]=mean(totoxa[u3[ns]],/nan)
    sca[j,3]=stddev(totoxa[u3[ns]],/nan)
  endif

endfor

plot, totwater[u], totoxa[u], psym=2, title='Precipitable water for Ox-A',/nodata,$
 xtitle='Precipitable water (mm)',ytitle='Path integrated attenuation enhancement', xrange=[14,26],yrange=[0.5,3]

oplot, cavg,ca[*,0], psym=6, color=70
errplot,cavg,ca[*,0]-sca[*,0],ca[*,0]+sca[*,0],color=70

r=correlate(totwater[u],totoxa[u]) & r=r*r
l=linfit(totwater[u],totoxa[u])
x=findgen(30)
oplot, x, x*l[1]+l[0],color=70,linestyle=2

oplot, cavg,ca[*,1], psym=6, color=130
errplot,cavg,ca[*,1]-sca[*,1],ca[*,1]+sca[*,1],color=130
r1=correlate(totwater[u1],totoxa[u1]) & r1=r1*r1
l1=linfit(totwater[u1],totoxa[u1])
oplot, x, x*l1[1]+l1[0],color=130,linestyle=2

oplot, cavg,ca[*,2], psym=6, color=201
errplot,cavg,ca[*,2]-sca[*,2],ca[*,2]+sca[*,2],color=201
r2=correlate(totwater[u2],totoxa[u2]) & r2=r2*r2
l2=linfit(totwater[u2],totoxa[u2])
oplot, x, x*l2[1]+l2[0],color=201,linestyle=2

oplot, cavg,ca[*,3], psym=6, color=250
errplot,cavg,ca[*,3]-sca[*,3],ca[*,3]+sca[*,3],color=250
r3=correlate(totwater[u3],totoxa[u3]) & r3=r3*r3
l3=linfit(totwater[u3],totoxa[u3])
oplot, x, x*l3[1]+l3[0],color=250,linestyle=2
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;; repeat the above but with cloud base height
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

totbase=totbase/1000.
...
device, xsize=20, ysize=22
 ...
 tvlct,255,117,173,248
u=where(tottau gt 14. and tottau lt 16.5 and finite(totbase) eq 1 and totarea gt 0);  and totvalid eq 1)
u1=where(tottau gt 24. and tottau lt 25.5 and finite(totbase) eq 1); and totvalid eq 1)
u2=where(tottau gt 49. and tottau lt 51. and finite(totbase) eq 1); and totvalid eq 1)
u3=where(tottau gt 98. and tottau lt 102. and finite(totbase) eq 1); and totvalid eq 1)

cbins=findgen(26)*(8.-0.)/25.
cavg=(findgen(25)+0.5)*(8.-0.)/25.+0.
ca=fltarr(25,4)*!values.f_nan
sca=fltarr(25,4)*!values.f_nan
for j=0, 24 do begin
  ns=where(totbase[u] gt cbins[j] and totbase[u] le cbins[j+1],nu)
  if nu gt 0 then begin
    ca[j,0]=mean(totarea[u[ns]],/nan)
    sca[j,0]=stddev(totarea[u[ns]],/nan)
  endif
  ns=where(totbase[u1] gt cbins[j] and totbase[u1] le cbins[j+1],nu)
  if nu gt 0 then begin
    ca[j,1]=mean(totarea[u1[ns]],/nan)
    sca[j,1]=stddev(totarea[u1[ns]],/nan)
  endif
  ns=where(totbase[u2] gt cbins[j] and totbase[u2] le cbins[j+1],nu)
  if nu gt 0 then begin
    ca[j,2]=mean(totarea[u2[ns]],/nan)
    sca[j,2]=stddev(totarea[u2[ns]],/nan)
  endif
  ns=where(totbase[u3] gt cbins[j] and totbase[u3] le cbins[j+1],nu)
  if nu gt 0 then begin
    ca[j,3]=mean(totarea[u3[ns]],/nan)
    sca[j,3]=stddev(totarea[u3[ns]],/nan)
  endif
...
plot, totbase[u], totarea[u], psym=2, title='Cloud base height for 940 nm',/nodata,$
 xtitle='cloud base height (km)',ytitle='Path integrated attenuation enhancement', xrange=[0,8],yrange=[0.5,3]

oplot, cavg,ca[*,0], psym=6, color=70
errplot,cavg,ca[*,0]-sca[*,0],ca[*,0]+sca[*,0],color=70

r=correlate(totbase[u],totarea[u]) & r=r*r
l=linfit(totbase[u],totarea[u])
x=findgen(30)
oplot, x, x*l[1]+l[0],color=70,linestyle=2

oplot, cavg,ca[*,1], psym=6, color=130
errplot,cavg,ca[*,1]-sca[*,1],ca[*,1]+sca[*,1],color=130
r1=correlate(totbase[u1],totarea[u1]) & r1=r1*r1
l1=linfit(totbase[u1],totarea[u1])
oplot, x, x*l1[1]+l1[0],color=130,linestyle=2

oplot, cavg,ca[*,2], psym=6, color=201
errplot,cavg,ca[*,2]-sca[*,2],ca[*,2]+sca[*,2],color=201
r2=correlate(totbase[u2],totarea[u2]) & r2=r2*r2
l2=linfit(totbase[u2],totarea[u2])
oplot, x, x*l2[1]+l2[0],color=201,linestyle=2

oplot, cavg,ca[*,3], psym=6, color=250
errplot,cavg,ca[*,3]-sca[*,3],ca[*,3]+sca[*,3],color=250
r3=correlate(totbase[u3],totarea[u3]) & r3=r3*r3
l3=linfit(totbase[u3],totarea[u3])
oplot, x, x*l3[1]+l3[0],color=250,linestyle=2
...
device, xsize=20, ysize=22
 ...
 tvlct,255,117,173,248
u=where(tottau gt 14. and tottau lt 16.5 and finite(totbase) eq 1 and totarea gt 0)
u1=where(tottau gt 24. and tottau lt 25.5 and finite(totbase) eq 1)
u2=where(tottau gt 49. and tottau lt 51. and finite(totbase) eq 1)
u3=where(tottau gt 98. and tottau lt 102. and finite(totbase) eq 1)
...
plot, totbase[u], totoxa[u], psym=2, title='Cloud base height for Ox-A',/nodata,$
 xtitle='cloud base height (km)',ytitle='Path integrated attenuation enhancement', xrange=[0,8],yrange=[0.5,3]

oplot, cavg,ca[*,0], psym=6, color=70
errplot,cavg,ca[*,0]-sca[*,0],ca[*,0]+sca[*,0],color=70

r=correlate(totbase[u],totoxa[u]) & r=r*r
l=linfit(totbase[u],totoxa[u])
x=findgen(30)
oplot, x, x*l[1]+l[0],color=70,linestyle=2

oplot, cavg,ca[*,1], psym=6, color=130
errplot,cavg,ca[*,1]-sca[*,1],ca[*,1]+sca[*,1],color=130
r1=correlate(totbase[u1],totoxa[u1]) & r1=r1*r1
l1=linfit(totbase[u1],totoxa[u1])
oplot, x, x*l1[1]+l1[0],color=130,linestyle=2

oplot, cavg,ca[*,2], psym=6, color=201
errplot,cavg,ca[*,2]-sca[*,2],ca[*,2]+sca[*,2],color=201
r2=correlate(totbase[u2],totoxa[u2]) & r2=r2*r2
l2=linfit(totbase[u2],totoxa[u2])
oplot, x, x*l2[1]+l2[0],color=201,linestyle=2

oplot, cavg,ca[*,3], psym=6, color=250
errplot,cavg,ca[*,3]-sca[*,3],ca[*,3]+sca[*,3],color=250
r3=correlate(totbase[u3],totoxa[u3]) & r3=r3*r3
l3=linfit(totbase[u3],totoxa[u3])
oplot, x, x*l3[1]+l3[0],color=250,linestyle=2
...
u=where(totwater gt 13.5 and totwater lt 16.5 and totbase gt 500. and totbase lt 1500.)
...
plot, tottau[u], totarea[u], psym=3, title='Water vapor per Oxygen-A',xtitle='Cloud optical depth',$
 ytitle='!9'+string(ki)+'!X!Denh,water!N / !9'+string(ki)+'!X!Denh, Ox-A!N', xrange=[0,200],yrange=[0,5],/nodata
