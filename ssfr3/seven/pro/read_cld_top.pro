...
for i=0, nf-1 do begin
  ...
  ncdf_varget,fileid,26,ph ; cloud phase
  ncdf_close,fileid
  ...
  top[i]=up[ns]
  bot[i]=dn[ns]
  pha[i]=ph[ns] ;0:snow, 1:water, 2:ice, 3:N/A, 4:clear, 5:bad, 6:suspected water, 7:suspected ice
 print, cod[i],def[i],lwp[i],top[i],bot[i],pha[i]
endfor

save, pha,cod,def,lwp,top,bot,file,filename='./goes_cld_top.out'
