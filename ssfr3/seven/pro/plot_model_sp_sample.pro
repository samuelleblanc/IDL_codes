...
sps=fltarr(24,15,378,2,n_elements(lbl))
spn=sps
for i=0, n_elements(lbl)-1 do begin
  f=fn+'sp_hires4_'+lbl[i]
  print, 'restoring: '+f
  restore, f
  sps[*,*,*,*,i]=sp
  for t=0, 23 do for r=0,14 do for w=0,1 do spn[t,r,*,w,i]=sps[t,r,*,w,i]/max(sps[t,r,*,w,i])
endfor
...
;  restore, fn
  ...
  wvl=zenlambda
  plot, wvl, sps[t,r,*,w,0],/nodata, yr=[0,0.40],ytitle='Radiance (Wm!U-2!Nnm!U-1!Nsr!U-1!N)',xtit='Wavelength (nm)',xr=[400,1700]
...
;  restore, fn
  ...
  t=0 & r=0
  cl=[40,253,135]
  plot, wvl, sps[ts[t],rs[r],*,0,0],/nodata, yr=[0,1.20],ytitle='Radiance (Wm!U-2!Nnm!U-1!Nsr!U-1!N)',xr=[400,1700],xtickname=[' ',' ',' ',' ',' ',' '],ymargin=[1.2,1],xticks=5
  ...
  legend, ['r!Deff!N=15 !9m!Xm','!9t!X='+string(tau[ts],format='(I3)'),'clear','ice','liquid'], textcolors=[0,cl,100,0,0],linestyle=[0,0,0,0,0,1,0],color=[255,255,255,255,255,0,0],pspacing=1.3,position=[900,1.1],/data,box=0,charsize=2.0
 ;legend, ['ice','liquid'],linestyle=[1,0],box=0, /right,/bottom,charsize=2.0,pspacing=1.3
  
  t=0
  plot, wvl, sps[ts[t],rs[r],*,0,0]/max(sps[ts[t],rs[r],*,0,0]),/nodata, yr=[0,1.00],ytitle='Normalized radiance',xr=[400,1700],xtickname=[' ',' ',' ',' ',' ',' '],ymargin=[1.2,1],xticks=5
  for t=0, n_elements(ts)-1 do begin
  ...
  legend, ['r!Deff!N=15 !9m!Xm'],textcolors=[0],/right,box=0,charsize=2.0
  ;legend, ['r!Deff!N=15 !9m!Xm','!9t!X='+string(tau[ts],format='(I3)'),'clear'], textcolors=[0,cl,100],/right,box=0,charsize=2.0
  ;legend, ['ice','liquid'],linestyle=[1,0],box=0, /right,/bottom,charsize=2.0,pspacing=1.3
  t=0
  plot, wvl, std[ts[t],rs[r],*,0,0],/nodata, yr=[0,0.10],ytitle='Standard deviation',xr=[400,1700],xtickname=[' ',' ',' ',' ',' ',' '],ymargin=[1.2,1],xticks=5
  for t=0, n_elements(ts)-1 do begin
 ...
 ;legend, ['ice','liquid'],linestyle=[1,0],box=0, /right,/bottom,charsize=2.0,pspacing=1.3
  ...
  r=1 & t=0
  plot, wvl, sps[ts[t],rs[r],*,0,0],/nodata,ytitle='Radiance (Wm!U-2!Nnm!U-1!Nsr!U-1!N)',xr=[400,1700],xtitle='Wavelength (nm)',ymargin=[3,-1],xticks=5
  for t=0, n_elements(ts)-1 do begin
    oplot, wvl, sps[ts[t],rs[r],*,0,0],color=cl[t]
    oplot, wvl, sps[ts[t],rs[r],*,1,0],color=cl[t],linestyle=1
  endfor
 ...
 legend, ['r!Deff!N=40 !9m!Xm'],textcolors=[0],/right,box=0,charsize=2.0
