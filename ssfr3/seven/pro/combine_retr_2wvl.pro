...
restore, '/argus/roof/SSFR3/data/'+date+'/out/'+date+'_cld_parms2_2wvl_1227nm.out' ;_sp20.out'
...
for i=0, n_elements(tmhrsi)-1 do begin
 ...
 ; ref_rtm[i]=ref[it] ;mean(ref[it-dt0:it+dt1],/nan)
...
tmhrs=tmhrsi
print, 'saving'
save, filename=dir+'retrieved_'+date+'_2wvl_1227nm.out',tmhrs,tau_rtm,ref_rtm,ref_err,tau_err,wp_rtm,wp_err
stop
endfor
