...
restore, '/home/leblanc/SSFR3/data/retrieved_kisq_model_v4.out'
kp=kis_rtm
...
set_plot, 'ps'
 ...
 device, xsize=40, ysize=40
  ...
  !p.multi=[0,2,2] & !x.margin=[5,1] & !y.margin=[3,3] & !y.omargin=[0,0] & !x.omargin=[0,6]

diftau=float(ind)
difref=float(ind)
for t=0, n_elements(ind[*,0,0])-1 do diftau[t,*,*]=(tau_rtm[ind[t,*,*]]-tau[t])/tau[t]*100.
for r=0, n_elements(ref)-1 do difref[*,r,*]=(ref_rtm[ind[*,r,*]]-ref[r])/ref[r]*100.
...
lvl=findgen(31)/30.*40.-20.
lvls=[-100,lvl,100]

contour, diftau[*,0:15,0],tau,ref[0:15],/fill,levels=lvls, xtitle='!9t!X',ytitle='r!De!N (!9m!Xm)',title='!9t!X bias - Liquid';,title='Liquid - !9Dt!X'
contour, diftau[*,2:*,1],tau,ref[2:*],/fill,levels=lvls, xtitle='!9t!X',ytitle='r!De!N (!9m!Xm)',title='!9t!X bias - Ice';,title='Ice - !9Dt!X'
contour, difref[*,0:15,0],tau,ref[0:15],/fill,levels=lvls, xtitle='!9t!X',ytitle='r!De!N (!9m!Xm)',title='r!De!N bias - Liquid';,title='Liquid - !9D!Xr!De!N'
contour, difref[*,2:*,1],tau,ref[2:*],/fill,levels=lvls, xtitle='!9t!X',ytitle='r!De!N (!9m!Xm)',title='r!De!N bias - Ice';,title='Ice - !9D!Xr!De!N'

 contour,transpose([[lvl],[lvl]]),[0,1],lvl,levels=lvls,/cell_fill,ystyle=9,yticks=10,$
  ytickname=replicate(' ',11),position=[0.86,0.1,0.88,0.95],/normal,/noerase,xticks=1,xtickname=[' ',' ']
 axis,yaxis=1,ytitle='Difference (%)',yrange=[min(lvl),max(lvl)],yticks=10
