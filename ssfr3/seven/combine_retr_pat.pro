...
restore, '/argus/roof/SSFR3/data/'+date+'/out/'+date+'_cld_parms2.out' ;_sp20.out'
...
tmhrs=tmhrsi
print, 'saving'
save, filename=dir+'retrieved_'+date+'_pat.out',tmhrs,tau_rtm,ref_rtm,ref_err,tau_err,wp_rtm,wp_err
;stop
endfor
end
