...
restore, '/argus/SSFR3/model/sp_liq_ice.out'
...
set_plot, 'ps'
 ...
 device, xsize=20, ysize=20
  ...
  oplot,zenlambda, smooth(deriv(zenlambda,sp[2,1,*,0]/max(sp[2,1,*,0])),2), color=70 
  oplot,zenlambda, smooth(deriv(zenlambda,sp[2,4,*,0]/max(sp[2,4,*,0])),2), color=250
  ...
  oplot,zenlambda, smooth(deriv(zenlambda,sp[2,1,*,1]/max(sp[2,1,*,1])),2), color=70, linestyle=2
  oplot,zenlambda, smooth(deriv(zenlambda,sp[2,4,*,1]/max(sp[2,4,*,1])),2), color=250, linestyle=2
...
set_plot, 'ps'
 ...
 device, xsize=20, ysize=20
  ...
  plot, zenlambda, sp[0,1,*,0]/max(sp[0,1,*,0]),xtitle='Wavelength (nm)',$
   ytitle='Normalized radiance',title='Modeled ice/liquid water cloud spectra',xrange=[900,1650], yrange=[0,0.5]
  oplot,zenlambda, sp[0,4,*,0]/max(sp[0,4,*,0]), color=120
  oplot,zenlambda, sp[2,1,*,0]/max(sp[2,1,*,0]), color=70
  oplot,zenlambda, sp[2,4,*,0]/max(sp[2,4,*,0]), color=250

  oplot,zenlambda, sp[0,1,*,1]/max(sp[0,1,*,1]), linestyle=2
  oplot,zenlambda, sp[0,4,*,1]/max(sp[0,4,*,1]), color=120, linestyle=2
  oplot,zenlambda, sp[2,1,*,1]/max(sp[2,1,*,1]), color=70, linestyle=2
  oplot,zenlambda, sp[2,4,*,1]/max(sp[2,4,*,1]), color=250, linestyle=2
...
set_plot, 'ps'
 ...
 device, xsize=20, ysize=20
  ...
  plot, zenlambda, sp[0,1,*,0],xtitle='Wavelength (nm)',$
   ytitle='Radiance (W/m!U2!N nm sr)',title='Modeled ice/liquid water cloud spectra', yrange=[0,0.4]
  oplot,zenlambda, sp[0,4,*,0], color=120
  oplot,zenlambda, sp[2,1,*,0], color=70
  oplot,zenlambda, sp[2,4,*,0], color=250

  oplot,zenlambda, sp[0,1,*,1], linestyle=2
  oplot,zenlambda, sp[0,4,*,1], color=120, linestyle=2
  oplot,zenlambda, sp[2,1,*,1], color=70, linestyle=2
  oplot,zenlambda, sp[2,4,*,1], color=250, linestyle=2
...
set_plot, 'ps'
 ...
 device, xsize=60, ysize=20
  ...
  legend, ['ref=10 um, tau=50 ','ref=10 um, tau=150','ref=25 um, tau=50 ','ref=25 um, tau=150'],textcolors=[0,70,120,250],box=0,/right,charsize=2.0
