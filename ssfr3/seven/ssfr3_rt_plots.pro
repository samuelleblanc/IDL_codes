...
;
; CATEGORY:
;   SSFR3 real time data module   
;
; CALLING SEQUENCE:
;   SSFR3_rt_plots, wvl, utc, spect, spect_cal,sza, extra,rnav, ssfr_temp
...
;---------------------------------------------------------------------------
@legend.pro
pro ssfr3_rt_plots, wvl, utc, spect, spect_cal, sza, extra, rnav, ssfr_temp
