...
restore, dir+'sample_kisq2_20120525.out' ;liquid
...
restore, dir+'sample_kisq2_20130110.out' ;ice
...
restore, dir+'sample_kisq2_20120806.out' ;liquid/mix
...
spp3[t3-1,r3-1,*,w3]=spp3[t3-1,r3-1,*,w3]-0.0025
  ...
  fp=dir+'..\plots\kisq\kisq_samp_sp2'
  print, 'making plot :'+fp
  set_plot, 'ps'
  loadct, 39, /silent
  device, /encapsulated, /tt_font, set_font='Helvetica Bold',/color,bits_per_pixel=8., filename=fp+'.ps'
...
ff3=1.;19842 
  ...
  plot, wvl,sp3, ytitle='Radiance!C(Wm!U-2!Nnm!U-1!Nsr!U-1!N)',xr=[400,1700],xtickname=xtn,$
   yr=[0,0.18] ,title='B - Mixed-pase',xticks=5 ;for samp3 yr=[0,0.22]
  ...
  oplot,wvlm,spp3[tv3-1,rv3-1,*,0]*ff3,color=250
  ;oplot,wvlm,spp3[t3i,r3i,*,1]*ff3,color=150,linestyle=2
  ...
  legend,['!9t!X=26, r!De!N=30 !9m!Xm, liquid','!9t!X='+strtrim(t3,2)+', r!De!N='+strtrim(r3,2)+' !9m!Xm, ice',$
          '!9t!X=25, r!De!N=30 !9m!Xm','!9t!X=28, r!De!N=30 !9m!Xm'],$
 textcolors=[150,151,50,250],box=0,position=[1720,0.17],charsize=2.0,$
...
;ff=findgen(n_elements(wvlm))/n_elements(wvlm)/20.+0.975
  ...
  legend,['!9t!X=8, r!De!N=15 !9m!Xm','!9t!X='+strtrim(ts2,2)+', r!De!N='+strtrim(rs2,2)+' !9m!Xm',$
...
tvlct,190,190,190,200
  ...
  xyouts,450,-15,'15.07 UTC',charsize=2.0

  plot,wvlm,(spn3-spp3[t3-1,r3-1,*,w3])/spn3*100.,ytitle='Radiance!Cdifference (%)',xr=[400,1700],$
   xtit='Wavelength (nm)',/nodata,yr=[-40,30],xticks=5
  oplot,wvlm,wvlm*0.,linestyle=1,color=200
  oplot,wvlm,(spn3-spp3[t3-1,r3-1,*,w3])/spn3*100.,color=151,linestyle=5*w3 
  ...
  xyouts, 450, -28,'17.52 UTC',charsize=2.0

  device, /close 
  spawn, 'convert '+fp+'.ps '+fp+'.png' 

;for analysis
sk1=(spn1-spp1[t1-1,r1-1,*,w1])/spn1*100.
ss1=(spn1-spp1[ts1-1,rs1-1,*,0])/spn1*100.
sv1=(spn1-spp1[tv1-1,rv1-1,*,0])/spn1*100.

sk2=(spn2-spp2[t2-1,r2-1,*,w2])/spn2*100.
ss2=(spn2-spp2[ts2-1,rs2-1,*,1])/spn2*100.
sv2=(spn2-spp2[tv2-1,rv2-1,*,1])/spn2*100.

sk3=(spn3-spp3[t3-1,r3-1,*,w3])/spn3*100.
ss3=(spn3-spp3[ts3-1,rs3-1,*,0])/spn3*100.
sv3=(spn3-spp3[tv3-1,rv3-1,*,0])/spn3*100.
sk3l=(spn3-spp3[t3l,r3l,*,0])/spn3*100.
