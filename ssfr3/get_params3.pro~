...
sp=smooth(spc,2)/mean(spc[mm:mn]) ;max(spc,mm)
nul=min(abs(wvl-1050.),i000)
sp2=smooth(spc,2)/spc[i000]
...
nul=min(abs(wvl-565.),io)
nul=min(abs(wvl-634.),in)
par[15]=sp[io]/sp[in]
