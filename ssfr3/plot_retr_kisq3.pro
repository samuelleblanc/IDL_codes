...
is=intarr(nlbl,4)
  ...
  device, xsize=45, ysize=20
   ...
   !p.multi=[0,3,4,0,1] & !x.margin=[6,0.2] & !y.margin=[3,3] & !y.omargin=[1,0] & !x.omargin=[0,14]
...
;    if ii[1] gt 0 then oplot, utc[fl[0:ii[1],1]],refs[fl[0:ii[1],1],1],color=50,psym=4,thick=2
  ...
  plot, utc[fl[0:ii[0],0]],smooth(ki[fl[0:ii[0],0]],2), yrange=[0.,0.1],ytitle='!9c!X!U2!N',xtickname=nul,$
