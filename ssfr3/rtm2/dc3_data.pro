...
;   dc3_dark.pro  ;dark spectra finder (procedure ini_dark and read_drk)
;   
; NEEDED FILES:
;   - config file for day
;   - all ".OSA2" files for the day under the proper directory (/dc3/p3/*date*/)
;  
; EXAMPLE:
;   dc3_data, 20100421
;
...
indir  = '/data/seven/schmidt/dc3/cal/SSFR5'           ; directory
