...
lbl='20120525_snd'
restore, 'C:\Users\Samuel\Research\SSFR3\data\Pars_std_meas_lut_v6_'+lbl+sno+'.out'
;stop
restore, 'C:\Users\Samuel\Research\SSFR3\data\par_sza_v1_20120525.out'
avg=pars[*,*,*,*,1]
...
set_plot, 'ps'
 ...
 device, xsize=40, ysize=26
  ...
  !p.multi=[0,4,4,0,0] & !x.margin=[6,1.5] & !y.margin=[0.155555,0.4] & !y.omargin=[3,1]
...
tau=tau_hires
 for p=0, 14 do begin
  ...
  if p eq 10 then yr[1]=max(avg[0:99,[09,19,29],*,p]+std[0:99,[09,19,29],*,p],/nan)*0.96
