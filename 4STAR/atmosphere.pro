...
; Modified: By Samuel LeBlanc, March 21st, 2014, Cupertino, CA
;           - modified to use the data from SEAC4RS (not aircraft)
;---------------------------------------------------------------------------
@magnus.pro
...
dd='C:\Users\Samuel\Research\SEAC4RS\wx\'
dd='C:\Users\Samuel\Research\4STAR\model\arctic\'
;standard_atmosphere=dd+'data\afglmw.dat'
standard_atmosphere=dd+'afglss.dat'
;file=dd+'data\atmos_areo_'+date
file=dd+'atmos_aero_'+date
sounding=dd+'sounding_'+date+'_barrow.dat'
